...
public class romance1 extends JPanel {
...
this.setBackground(Color.WHITE);
        ...
        try (
             ...
             ResultSet resultSet = statement.executeQuery("SELECT * FROM bookadd WHERE category = 'romance'")) {
...
buyButton.addActionListener(e -> {
            ...
            try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
                ...
                try (
                    ...
                    preparedStatement.setString(1, book.getName());
                    preparedStatement.setInt(2, book.getPrice());
                    preparedStatement.setString(3, "romance"); // Assuming category is "horror"
                    preparedStatement.executeUpdate();
