...
public class Fantasy extends JPanel {
...
this.setBackground(Color.WHITE);
        ...
        try (
             ...
             ResultSet resultSet = statement.executeQuery("SELECT * FROM bookadd WHERE category = 'fantasy'")) {
...
buyButton.addActionListener(e -> {
            ...
            try (Connection connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD)) {
                ...
                try (
                    ...
                    preparedStatement.setString(1, book.getName());
                    preparedStatement.setInt(2, book.getPrice());
                    preparedStatement.setString(3, "fantasy"); // Assuming category is "horror"
                    preparedStatement.executeUpdate();
   ...
   public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            JLabel fantasyLabel = new JLabel("Fantasy", SwingConstants.CENTER);
            fantasyLabel.setFont(new Font("MV boli", Font.BOLD, 30));
            fantasyLabel.setForeground(Color.WHITE);
            topPanel.add(fantasyLabel);
